...
<div class="card border shadow-none position-relative overflow-hidden mb-4">
  <div class="card-body px-4 py-3">
    <div class="row align-items-center">
      <div class="col-9">
        <h4 class="fw-semibold mb-8">Nueva Plantilla</h4>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="<?= site_url('templates/store') ?>" method="post" autocomplete="off">
                    <?= csrf_field() ?>
                    <div class="mb-3">
                        <label for="plantilla_nombre" class="form-label">Nombre de la plantilla</label>
                        <input type="text" class="form-control" id="plantilla_nombre" name="plantilla_nombre" placeholder="Ej. Cambio de CM" value="<?= old('plantilla_nombre') ?>">
                    </div>
                    <div class="mb-4">
                        ...
                        <textarea class="form-control font-monospace text-warning bg-dark" id="plantilla_txt" name="plantilla_txt" rows="8" placeholder="Escribe el texto de la plantilla..."><?= old('plantilla_txt') ?></textarea>
                    </div>
                    <div class="d-flex justify-content-center mt-4 gap-2 border-top pt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-4">
                            <i class="ti ti-device-floppy me-1"></i>Crear Plantilla
                        </button>
                    </div>
                </form>
            </div>
