...
<head>
  ...
  <title>Activa tu cuenta - Sistema</title>
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form action="<?= url_to('auth-action-verify') ?>" method="post" novalidate autocomplete="off">
                  ...
                  <div class="mb-4">
                    <label for="token" class="form-label">Código de Activación</label>
                    <input type="text" class="form-control text-center fs-5" id="token" name="token" autocomplete="one-time-code" placeholder="000000" inputmode="numeric" value="<?= old('token') ?>">
                  </div>
                  
                  <button type="submit" class="btn btn-primary w-100 py-8 mb-3 rounded-2">Activar Cuenta</button>
                  
                  <div class="text-center">
                    <a class="text-primary fw-medium fs-3" href="<?= url_to('auth-action-show') ?>">Reenviar correo de confirmación</a>
                  </div>
                </form>
