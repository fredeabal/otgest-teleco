...
class Auth extends ShieldAuth
{
    ...
    public array $views = [
        ...
        'action_email_activate_show'  => '\App\Views\Auth\activation_code',
        'action_email_activate_email' => '\App\Views\Auth\emails\activation',
        'magic-link-login'            => '\App\Views\Auth\magic_link_form',
        'magic-link-message'          => '\App\Views\Auth\magic_link_message',
        'magic-link-email'            => '\App\Views\Auth\emails\magic_link',
    ];
    ...
    public array $redirects = [
        'register'          => 'auth/logout-activated',
        'login'             => '/',
        'logout'            => '/',
        'force_reset'       => '/',
        'permission_denied' => '/',
    ...
    public array $authenticators = [
        ...
        'magic-link' => \CodeIgniter\Shield\Authentication\Authenticators\MagicLink::class,
        // 'jwt'     => JWT::class,
    ];
     ...
     */
    public array $personalFields = ['name', 'phone', 'profile_pic', 'theme'];
    ...
    public function loginRedirect(): string
    {
        ...
        // Si la URL antes del login es un endpoint de AJAX/JSON o está vacía, redirigimos al default '/' (dashboard)
        if (empty($url) || 
            strpos($url, 'realtime-status') !== false || 
            strpos($url, 'details-json') !== false || 
